...
//   try {
//     let bruh = `${usedPrefix}open <crate name> < 1 | 10 | 100 | 1000 >\n\nUsage examples: *${usedPrefix}open common 10*\n\nlist crate:\n*common*\n*uncommon*\n*mythic*\n*legendary*`
//     let _lmao = args[0]
//     let Lmao = `Only support 1, 10, 100, 1000\nUsage examples: *${usedPrefix}open ${args > 2 ? _lmao : pickRandom(['common', 'uncommon', 'mythic', 'legendary'])} 10*`
...
//                     } else conn.reply(m.chat, 'Common crate not enough', m)
//                     break
//                 case '10':
...
//                     } else conn.reply(m.chat, 'Common crate is not enough', m)
//                     break
//                 case '100':
...
//                         if (umc > 0) {
//                             m.reply(`*Congratulations you got item Rare that is*\n${umc} Mythic Crate`)
//                             global.db.data.users[m.sender].mythic += umc * 1
//                         }
//                     } else conn.reply(m.chat, 'Uncommon crate is not enough', m)
//                     break
//                 case '10':
...
//                         }
//                         if (ml > 0) {
//                             m.reply(`*Congratulations you got item Epic that is*\n${ml} Legendary Crate`)
//                             global.db.data.users[m.sender].legendary += ml * 1
//                         }
//                     } else conn.reply(m.chat, 'Mythic crate is not enough', m)
//                     break
//                 case '10':
...
//                         }
//                         if (ll > 0 || lpp > 0) {
//                              m.reply(`*Congratulations you got item Epic that is*${ll > 0 ? `\n${ll} Legendary Crate` : ''}${lpp > 0 ? `\n${lpp} Pet Crate` : ''}`)
//                             global.db.data.users[m.sender].legendary += ll * 1
//                             global.db.data.users[m.sender].pet += lpp * 1
//                         }
//                     } else conn.reply(m.chat, 'Legendary crate is not enough', m)
//                     break
//                 case '10':
...
//                         }
//                         if (ll1 > 0 || lpp1 > 0) {
//                              m.reply(`*Congratulations you got item Epic that is*${ll1 > 0 ? `\n${ll1} Legendary Crate` : ''}${lpp1 > 0 ? `\n${lpp1} Pet Crate` : ''}`)
...
//                         }
//                         if (ll2 > 0 || lpp2 > 0) {
//                              m.reply(`*Congratulations you got item Epic that is*${ll2 > 0 ? `\n${ll2} Legendary Crate` : ''}${lpp2 > 0 ? `\n${lpp2} Pet Crate` : ''}`)
...
//                         }
//                         if (ll3 > 0 || lpp3 > 0) {
//                              m.reply(`*Congratulations you got item Epic that is*${ll3 > 0 ? `\n${ll3} Legendary Crate` : ''}${lpp3 > 0 ? `\n${lpp3} Pet Crate` : ''}`)
...
//             let _pet = `${pickRandom(['cat', 'fox', 'horse'])}`.trim()
...
//                     conn.reply(m.chat, `You already have a pet ${_pet}, Your reward is replaced with 2 potion${mknp > 0 ? ` And ${mknp} Food Pet` : ''}`, m)
//                 } else if (_pet == 'cat' && cat == 0) {
//                     global.db.data.users[m.sender].cat += 1
//                     global.db.data.users[m.sender].makananpet += mknp * 1
//                     conn.reply(m.chat, `*Congratulations you got pet${_pet} ${mknp > 0 ? ` And ${mknp} Food Pet*` : '*'}`, m)
...
//                 } else {
//                     global.db.data.users[m.sender].makananpet += mknp * 1
//                     m.reply(pickRandom(['youre unlucky', 'Try to open again next time, the arena doesnt get a pet', 'Im sorry I didnt get a pet', 'Maybe I dont get a pet', 'wkwkkwkwke']) + '. you only get *' + mknp + '* Food pet')
//                 }
//             } else m.reply('Your Pet Crate is not enough')
//             break
//         default:
